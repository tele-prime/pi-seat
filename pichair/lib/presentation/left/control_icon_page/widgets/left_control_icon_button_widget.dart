...
class LeftControlIconButtonWidget extends StatelessWidget {
  ...
  const LeftControlIconButtonWidget({
    super.key,
    required this.index,
    required this.label,
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LeftControlIconPageController>(builder: (controller) => SizedBox(
