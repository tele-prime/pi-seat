...
class LeftControlTouchPageAppbar extends StatelessWidget {

  final double size;

  const LeftControlTouchPageAppbar({super.key, required this.size});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<LeftControlTouchPageController>(builder: (controller) => Padding(
