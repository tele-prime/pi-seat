...
class LeftSeatTouchPageAppbar extends StatelessWidget {

  final double size;

  const LeftSeatTouchPageAppbar({super.key, required this.size});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<LeftSeatTouchPageController>(builder: (controller) => Padding(
