...
class RightControlButtonAppbar extends StatelessWidget {
  const RightControlButtonAppbar({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RightControlButtonPageController>(builder: (controller) => Padding(
